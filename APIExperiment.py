# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 10:18:48 2020
...
import numpy as np # math library, yay! use np.____ to access the stuff in this library
...
#create objects/inital conditions/local variables
    ...
    def getData(self, URL=URL):
        '''Pulls data from URL (API only) and parses it into a data dictionary. You should call this rarely--there are request time limits!'''
